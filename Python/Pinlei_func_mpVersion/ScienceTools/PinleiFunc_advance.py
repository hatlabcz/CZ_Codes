...
tk.Label(root, text = '          Constants Related          ').grid(column = 1, row = 0)
tk.Label(root, text = '          Qubit Related          ').grid(column = 0, row = 0)
tk.Label(root, text = '          JPC Related          ').grid(column = 2, row = 0)
     
tk.Button(root, text = 'Calculation of JJ', width = 15,
          command = QF.cal_junction).grid(column = 0, row = 1)
tk.Button(root, text = 'BBQ Analysis', width = 15,
          command = QF.hfss_simulation).grid(column = 0, row = 2)
tk.Button(root, text = 'g SNAIL Analysis', width = 15,
          command = QF.hfss_simulation_snail).grid(column = 0, row = 3)
