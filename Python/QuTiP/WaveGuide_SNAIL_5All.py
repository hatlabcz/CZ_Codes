...
HAMIL_COUP =  (ga*A + gb*B + gc*C + gd*D + ge*E + ga.conjugate()*A_DAG + gb.conjugate()*B_DAG + gc.conjugate()*C_DAG + gd.conjugate()*D_DAG + ge.conjugate()*E_DAG)**2
...
HAMIL = [HAMIL_TI, [HAMIL_COUP, pump5]]   # for time depedent hamiltonian 
...
TLIST = np.linspace(0, 10000, 10001)
