...
gCJ2 = 0.04* 2.0 * np.pi
theta= np.pi/2.0
g_1 = 0.06 * 2.0 * np.pi * np.exp(1j * theta)
...
PSI0 = qt.tensor(qt.fock(NC1, 1), qt.fock(N1, 0))
PSI1 = qt.tensor(PSI0, qt.fock(N2, 0))
PSI = qt.tensor(PSI1, qt.fock(NC2, 0))
TLIST = np.linspace(0, 100, 401)
