$begin 'Profile'
	...
	$end 'ProfileGroup'
	$begin 'ProfileGroup'
		StartInfo='Time:  11/14/2018 11:32:05; Host: HATLAB-PC; Processor: 4; OS: NT 6.1; HFSS 2017.0.0'
		TotalInfo='Time:  11/14/2018 11:32:05, Status: Normal Completion'
		ProfileTask('', 0, 0, 0, 0, 0, 'Executing from C:\\Program Files\\AnsysEM\\AnsysEM18.0\\Win64\\HFSSCOMENGINE.exe', false, true)
		ProfileTask('RAM Limit', 0, 0, 0, 0, 0, 'hatlab-PC = 90.000000%', false, true)
		ProfileTask('', 0, 0, 0, 0, 0, 'Solution Basis Order: 1', false, true)
		ProfileTask('', 0, 0, 0, 0, 0, 'Adaptive Passes converged', false, true)
		ProfileTask('', 0, 0, 0, 0, 0, '', false, true)
		ProfileTask('Solution Process', 0, 0, 0, 0, 0, 'Elapsed time : 00:00:00 , Hfss ComEngine Memory : 40.3 M', false, true)
	$end 'ProfileGroup'
$end 'Profile'
